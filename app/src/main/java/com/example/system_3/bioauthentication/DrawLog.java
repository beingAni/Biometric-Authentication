...
public class DrawLog extends Activity implements OnClickListener {
    float xAxis = 0f;
    float yAxis = 0f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.draw_log);
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            case R.id.button1:
                ...
                h=aa;
                g=t1.getText().toString()+"-"+t2.getText().toString();
...

                {
                    ...
                    }else
                    {
                        ...
                        Intent i = new Intent(DrawLog.this,
                                Home3.class);
                        startActivity(i);
