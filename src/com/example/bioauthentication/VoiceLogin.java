...
public class VoiceLogin extends Activity implements TextToSpeech.OnInitListener,OnClickListener{
    ...
    protected void promptSpeechInput1() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT,getString(R.string.hello_world));
        try
        {
        ...
        {
            Toast.makeText(getApplicationContext(),getString(R.string.hello_world),Toast.LENGTH_SHORT).show();
        }
    }
